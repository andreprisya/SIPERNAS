<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LaporanKegiatanEdit.aspx.vb" Inherits="SistemInformasiPerjalananDinas.LaporanKegiatanEdit1" %>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <select class="form-control form-control-lg" id="exampleFormControlSelect2" placeholder="Status">
                      ...
                      <button type="submit" class="btn btn-gradient-primary me-2"><a href="/User-Dinas/View/KelolaLaporanKegiatan.aspx"/a>Update</button>
