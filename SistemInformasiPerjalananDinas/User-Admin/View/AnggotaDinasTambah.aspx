<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AnggotaDinasTambah.aspx.vb" Inherits="SistemInformasiPerjalananDinas.TambahAnggotaDinas" %>
          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Tambah Data Anggota Dinas
              </h3>
            </div>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="AnggotaDinas.aspx">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName2" placeholder="NIP">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName3">Alamat</label>
                        <input type="text" class="form-control" id="exampleInputName3" placeholder="Alamat">
                      </div>
                       <div class="form-group">
                        <label for="exampleInputName4">Nomor Telepon</label>
                        <input type="text" class="form-control" id="exampleInputName4" placeholder="Nomor Telepon">
                      </div>
                      <div class="form-group">
