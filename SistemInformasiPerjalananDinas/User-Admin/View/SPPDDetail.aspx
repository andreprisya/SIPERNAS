<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SPPDDetail.aspx.vb" Inherits="SistemInformasiPerjalananDinas.SPPDDetail1" %>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <address>
                          <p class="font-weight-bold">Lama Jalan (Hari)</p>
                          <p> 3</p>
                        </address>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <address>
                          <p class="font-weight-bold">Angkutan</p>
                          <p> Pesawat </p>
                        </address>
                      </div>
                    </div>
