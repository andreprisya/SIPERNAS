<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LaporanKegiatanEdit.aspx.vb" Inherits="SistemInformasiPerjalananDinas.LaporanKegiatanEdit" %>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="KelolaDataSppd.aspx">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" value="Fund is not received">
                      </div>
                      <div class="form-group">
                      <div class="form-group">
                        <label for="exampleInputName4">Tanggal</label>
                        <input type="text" class="form-control" id="exampleInputName4" value="Dec 5, 2017">
                      </div>
                        <div class="form-group">
                        <label for="exampleInputPassword4">Tempat Kegiatan</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" value="Pekanbaru">
                      </div>
                    ...
                    <select class="form-control form-control-lg" id="exampleFormControlSelect2" placeholder="Status">
                      ...
                      <button type="submit" class="btn btn-gradient-primary me-2"><a href="LaporanKegiatan.aspx"/a>Update</button>
                      <button class="btn btn-light"><a href="LaporanKegiatan.aspx"/a>Cancel</button>
                    </form>
                  </div>
                </div>
              </div>
