<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LaporanKegiatan.aspx.vb" Inherits="SistemInformasiPerjalananDinas.laporankegiatan" %>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td> 
                                ...
                                <button type="button" class="btn btn-outline-primary btn-icon-text btn-sm"> <a href="LaporanKegiatanEdit.aspx"/a>   Edit  <i class="mdi mdi-file-check btn-icon-append"></i></button>
                                ...
                                <button type="button" class="btn btn-outline-danger btn-icon-text btn-sm"> Delete <i class="mdi mdi-alert btn-icon-prepend"></i></button> 
                                 <button type="button" class="btn btn-outline-info btn-icon-text btn-sm"> <a href="LaporanKegiatanDetail.aspx"/a>  Detail <i class="mdi mdi-printer btn-icon-append"></i></button> 
                          </td>
                          </tr>
