<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SPPDEdit.aspx.vb" Inherits="SistemInformasiPerjalananDinas.SPPDEdit" %>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="SPPD.aspx">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName2" value="Survey Lokasi">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName3">Tanggal Diajukan</label>
                        <input type="text" class="form-control" id="exampleInputName3" value="19/11/2022">
                      </div>
                      <div class="form-group">
                        <label>Surat SPPD</label>
                        <input type="file" name="img[]" class="file-upload-default">
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled value="DavidGrey.pdf">
